cordova.define("@moodlehq/phonegap-plugin-push-analytics.PushNotification", function(require, exports, module) {
/**
...
module.exports = {
  ...
  logEvent: (successCallback, errorCallback, name, data, filter) => {
    exec(successCallback, errorCallback, 'PushNotification', 'logEvent', [name, data, filter]);
  },
  enableAnalytics: (successCallback, errorCallback, enabled) => {
    exec(successCallback, errorCallback, 'PushNotification', 'enableAnalytics', [enabled]);
  },
